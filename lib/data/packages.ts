...
export type AnalyticsLevel = "pixel-only" | "full-ga4";
...
export const packages: PackageTier[] = [
  {
    ...
    included: [
      ...
      "Website hosting",
      "Google Business Profile + Gmail/Workspace setup",
  ...
  },
  {
    ...
    included: [
      ...
      "AI Call Agent / virtual receptionist",
...
export const addOns: AddOn[] = [
  {
    ...
    pricing: "$59.99/mo + $15 per additional page/platform",
    description:
